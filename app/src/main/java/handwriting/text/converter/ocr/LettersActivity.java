...
//This works for digits and only capitalized alphabets - Source = https://github.com/oluwabajio/Handwriting-Text-Ocr-Recognition.git
public class LettersActivity extends AppCompatActivity {

    ActivityLettersBinding binding;
    private String MODEL_FILE = "emnist.tflite";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityLettersBinding.inflate(getLayoutInflater());
